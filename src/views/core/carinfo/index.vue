<template>
  <ContentWrap>
    ...
    <el-form
      ...
      label-width="68px"
    >
      <el-form-item label="名字" prop="carNumber">
        <el-input
      ...
      <el-form-item>
        ...
        <el-button
          ...
          v-hasPermi="['core:car-info:create']"
        >
        ...
        <el-button
          ...
          v-hasPermi="['core:car-info:export']"
        >
        ...
        <el-button
            ...
            v-hasPermi="['core:car-info:delete']"
        >
  ...
  <ContentWrap>
    ...
    <el-table-column type="selection" width="55" />
      ...
      <el-table-column label="名字" align="center" prop="carNumber" />
      <el-table-column
        label="创建时间"
        align="center"
        prop="createTime"
      ...
      <el-table-column label="操作" align="center" min-width="120px">
        <template #default="scope">
          <el-button
            ...
            v-hasPermi="['core:car-info:update']"
          >
            编辑
          </el-button>
          <el-button
